...
INSERT INTO `pages` (`page_id`, `page_name`, `page_title`, `page_detail`, `meta_title`, `meta_keyword`, `meta_description`, `is_active`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `users` (`user_id`, `username`, `password`, `name`, `contact_no`, `email`, `status`, `profile_image`, `profile_summary`, `auth_key`, `remember_token`, `created_at`, `updated_at`) VALUES
